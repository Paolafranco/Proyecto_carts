...
@Component({
  selector: 'app-manage-articules-create',
  templateUrl: './manage-articules-create.component.html',
  styleUrls: ['./manage-articules-create.component.css']
})
export class ManageArticulesCreateComponent implements OnInit {
  ...
  onSubmit(){
    ...
    if(form.valid) {
      ...
      .subscribe(data => {
        ...
        console.log(data)
        this.route.navigateByUrl('manage-articules');
      })
    }
  }
